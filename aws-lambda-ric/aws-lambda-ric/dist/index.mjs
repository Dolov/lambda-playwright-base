    ...
    function createResponseStream(options) {
      ...
      agent.createConnection = (opts, connectionListener) => {
        ...
        return net.createConnection(
          {
            ...opts,
            highWaterMark: (_a = options == null ? void 0 : options.httpOptions) == null ? void 0 : _a.highWaterMark
          },
          connectionListener
        );
      };
      ...
      req.write = function(chunk, encoding, callback) {
        ...
        if (typeof chunk !== "string" && !Buffer.isBuffer(chunk) && (chunk == null ? void 0 : chunk.constructor) !== Uint8Array) {
      ...
      getStreamForInvocationResponse(id, callback, options) {
        const ret = createResponseStream({
          httpOptions: {
            ...
            highWaterMark: options == null ? void 0 : options.highWaterMark
          }
        });
        return {
          request: ret.request,
...
var require_LogPatch = __commonJS({
  "LogPatch.js"(exports, module) {
    ...
    var _logToStdout = (level, message) => {
      let time = (/* @__PURE__ */ new Date()).toISOString();
    ...
    module.exports = class Runtime {
      ...
      async handleOnceStreaming() {
        ...
        let streamingContext = StreamingContext.build(
          ...
          invokeContext.invokeId,
          this.scheduleIteration.bind(this),
          ((_a = this.handlerMetadata) == null ? void 0 : _a.highWaterMark) ? { highWaterMark: this.handlerMetadata.highWaterMark } : void 0
        );
        const {
          responseStream,
          rapidResponse,
      ...
      _setDefaultExitListener(invokeId, markCompleted) {
        BeforeExitListener2.set(() => {
          markCompleted();
          this.client.postInvocationResponse(
            null,
            invokeId,
...
async function run(appRootOrHandler, handler = "") {
  ...
  const handlerFunc = UserFunction.isHandlerFunction(appRootOrHandler) ? appRootOrHandler : await UserFunction.load(appRootOrHandler, handler);
